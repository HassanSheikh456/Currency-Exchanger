...
const Home = () => {
  ...
  const convert = () => {
    setConvertedAmount(
      amount * ((currencyInfo as Record<string, number>)[to] || 0),
    );
  };
  ...
  return (
    ...
    >
      <div className="w-full">
        <div
          className="w-full max-w-md mx-auto border border-gray-600 
        ...
        >
          ...
          >
            <div className="w-full mb-1 text-black/50">
              <InputBox
                label="From"
                amount={amount}
            ...
            <div className="w-full mt-1 mb-4 text-black/50">
              <InputBox
                label="To"
